...
CREATE TABLE IF NOT EXISTS `role` (
  ...
  `context_n` INT NOT NULL COMMENT '上下文数。2-36的整数，默认16。AI回复时携带上下文的总条数，当小于10时，基本可以无限对话，值越小越节省token，但上下文的关联性会越差。值为2即一个回合（无上下文）。请根据对话长短自行调整。',
  `max_tokens` INT NOT NULL COMMENT '最大回复。1-2048的整数，默认1200。设置AI最大回复内容大小,会影响返回结果的长度。普通聊天建议100-300、短文生成建议500-900、长文、代码生成建议900-1200。',
